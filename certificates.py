...
class HopsteinerHopCertificate(AbstractHopCertificate):
    ...
    def get_lot_id(self):
        ...
        h_steiner_lot_id = self.source_soup.select_one('#root > div > main > div > div:nth-child(2) > div:nth-child('
                                                       '1) > table > tbody > tr:nth-child(1) > td:nth-child(3)').text
...
class CrosbyHopCertificate(AbstractHopCertificate):
...
class GlacierHopCertificate(AbstractHopCertificate):
